...
set :application, 'LedSHop'
set :repo_url, 'git@github.com:sergey-koba-mobidev/ledshop.git'
...
set :linked_dirs, fetch(:linked_dirs, []).push('log', 'tmp/pids', 'tmp/cache', 'tmp/sockets', 'public/spree')
